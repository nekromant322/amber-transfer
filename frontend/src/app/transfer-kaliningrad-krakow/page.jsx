...
export const metadata = {
  title: 'Трансфер Калининград — Краков | Заказать такси с водителем | Амбер Трансфер',
  description:
    'Трансфер из Калининграда в Краков на комфортных автомобилях бизнес-класса. Встреча с табличкой, фиксированная цена, профессиональные водители. Доставка в аэропорт Балице и центр Кракова.',
  alternates: { canonical: '/transfer-kaliningrad-krakow' },
  openGraph: {
    title: 'Трансфер Калининград — Краков',
    description: 'Персональный трансфер бизнес-класса из Калининграда в Краков.',
    locale: 'ru_RU',
    type: 'website',
...
const destinations = [
  {
    name: 'Аэропорт им. Иоанна Павла II (Балице)',
    note: 'международный аэропорт Кракова',
    distance: '670 км',
    time: '~8,5–9 часов',
  },
  {
    name: 'Центр Кракова',
    note: 'Рыночная площадь и Вавельский замок',
    distance: '670 км',
    time: '~8,5–9 часов',
  },
]
...
const faq = [
  {
    q: 'Сколько времени занимает трансфер до Кракова?',
    a: 'В среднем 8,5–9 часов в пути с учётом пересечения границы на переходе Мамоново — Гжехотки. Время пограничного контроля от часа и зависит от дня недели и времени суток.',
  },
  {
...
export default function TransferKaliningradKrakow() {
  return (
    <>
      <Nav />
      <FaqSchema faq={faq} />
      <ArticleSchema url="https://ambertransfer.ru/transfer-kaliningrad-krakow" headline="Трансфер Калининград — Краков" text={articleText} />
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.container}>
            ...
            <h1 className={styles.title}>
              Трансфер Калининград <span className={styles.arrow}>→</span> Краков
            </h1>
            <p className={styles.lead}>
              ...
              доставляем в любую точку Кракова — без пересадок и лишних остановок.
            </p>

            <div className={styles.facts}>
              <div className={styles.fact}>
                <strong>670 км</strong>
        ...
        <section className={styles.section}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>Куда именно в Кракове</h2>
            <p className={styles.sectionDesc}>
              Довезём в любую точку города, включая аэропорт им. Иоанна Павла II.
            </p>
