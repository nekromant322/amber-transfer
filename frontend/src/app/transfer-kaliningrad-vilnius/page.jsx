...
export const metadata = {
  title: 'Трансфер Калининград — Вильнюс | Заказать такси с водителем | Амбер Трансфер',
  description:
    'Трансфер из Калининграда в Вильнюс на комфортных автомобилях бизнес-класса. Встреча с табличкой, фиксированная цена, профессиональные водители. Доставка в любую точку Вильнюса.',
  alternates: { canonical: '/transfer-kaliningrad-vilnius' },
  openGraph: {
    title: 'Трансфер Калининград — Вильнюс',
    description: 'Персональный трансфер бизнес-класса из Калининграда в Вильнюс.',
    locale: 'ru_RU',
    type: 'website',
...
const destinations = [
  {
    name: 'Аэропорт Вильнюса',
    note: 'международный аэропорт литовской столицы',
    distance: '~330 км',
    time: '~6 часов',
  },
  {
    name: 'Центр Вильнюса',
    note: 'Старый город и деловые районы',
    distance: '~330 км',
    time: '~6 часов',
  },
]
...
const faq = [
  {
    q: 'Сколько времени занимает трансфер до Вильнюса?',
    a: 'В среднем около 6 часов в пути с учётом пересечения границы на автомобильном переходе Чернышевское — Кибартай — том же, через который проходит маршрут на Каунас. Пограничный контроль обычно занимает около 2 часов и зависит от загруженности пункта пропуска.',
  },
  {
...
export default function TransferKaliningradVilnius() {
  return (
    <>
      <Nav />
      <FaqSchema faq={faq} />
      <ArticleSchema url="https://ambertransfer.ru/transfer-kaliningrad-vilnius" headline="Трансфер Калининград — Вильнюс" text={articleText} />
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.container}>
            ...
            <h1 className={styles.title}>
              Трансфер Калининград <span className={styles.arrow}>→</span> Вильнюс
            </h1>
            <p className={styles.lead}>
              ...
              доставляем в любую точку Вильнюса — без пересадок и лишних остановок.
            </p>

            <div className={styles.facts}>
              <div className={styles.fact}>
                <strong>~330 км</strong>
        ...
        <section className={styles.section}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>Куда именно в Вильнюсе</h2>
            <p className={styles.sectionDesc}>
              Довезём в любую точку города, включая аэропорт Вильнюса.
            </p>
